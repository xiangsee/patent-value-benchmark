...
**Patent:** US14/261,087 — Antigen binding proteins to proprotein convertase subtilisin kexin type 9 (PCSK9)
**Ledger:** `LEDGER-NA-AMGEN-US8859741`
**Mode:** public
...
- `US8859741B2:claim 7` → `VC-AMGEN-PRALUENT` — **implemented_in** (confirmed)
...
- **other**: V0.7 records R4 implementation/scale but has no structured field showing that claim 7 was invalid for lack of enablement at T0. Claim-level rights-control status is therefore hidden in evidence/notes rather than represented as a comparable state. (observability: `public`)
